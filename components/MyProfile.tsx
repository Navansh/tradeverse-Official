...
const MyProfile = () => {
  ...
  const { stream, userStore } = useStoreContext();
  console.log(stream);
      ...
      {userStore?.map((item, i) => (
         ...
         <div className="flex relative flex-col justify-center w-[100%]">
           <div className="mt-[40px] flex items-center justify-center">
             <Image
               src={`${
                 item.cover ? `https://gateway.pinata.cloud/ipfs/${item.cover}` : bgImage
               }`}
               width={300}
               height={500}
           ...
           <Image
             src={`${
               item.profile ? `https://gateway.pinata.cloud/ipfs/${item.profile}` : bgImage
             }`}
             width={300}
             height={500}
             alt="bgimage"
